...
| `accessCodeOption`         | Access Code login option button      | [LoginOptions](/react/components/LoginOptions.js)                                                                                                                                                                                            |
| `emailPasswordOption`      | Email/ Password login option button  | [LoginOptions](/react/components/LoginOptions.js)                                                                                                                                                                                            |
| `facebookOption`           | Facebook login option button         | [OAuth](/react/components/OAuth.js)                                                                                                                                                                                                          |
| `googleOption`             | Google login option button           | [OAuth](/react/components/OAuth.js)                                                                                                                                                                                                          |
| `customOAuthOption`        | Custom OAuth login option button     | [OAuth](/react/components/OAuth.js)                                                                                                                                                                                                          |
